...
class subandpub
{
  ...
  void chatterCallback(const sensor_msgs::Imu::ConstPtr& msg)
  {
    ...
    // ROS_INFO("Imu Orientation x: [%f], y: [%f], z: [%f], w: [%f]", msg->orientation.x,msg->orientation.y,msg->orientation.z,msg->orientation.w);
    boost::array<double, 9> bla = msg->orientation_covariance;
    ...
    bla[8] = 2*1e-5;
    new_msg = *msg;
    new_msg.orientation_covariance = bla;
    new_msg.angular_velocity_covariance = bla;
    new_msg.linear_acceleration_covariance = bla;
